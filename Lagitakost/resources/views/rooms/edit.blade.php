...
<div class="logout-popup-overlay" id="logoutPopup">
    <div class="logout-popup">
        ...
        <div class="logout-popup-body">
            <div class="logout-popup-icon">⚠️</div>
            <p class="logout-popup-message">Apakah Anda yakin ingin logout?</p>
            <p class="logout-popup-submessage">Anda akan diarahkan ke halaman login.</p>
        </div>
        <div class="logout-popup-actions">
            <button class="logout-popup-btn logout-popup-btn-cancel" onclick="closeLogoutPopup()">Batal</button>
...
<div class="form-container">
    <div class="form-header">
        <h1 class="form-title">Edit Kamar</h1>
        <p class="form-subtitle">Perbarui detail kamar "{{ $room->name }}"</p>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('rooms.update', $room) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-input" value="{{ old('name', $room->name) }}" placeholder="Contoh: Tipe A - 101" required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" class="form-input" value="{{ old('price', $room->price) }}" placeholder="500000" min="0" required>
                @error('price')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="capacity" name="capacity" class="form-input" value="{{ old('capacity', $room->capacity) }}" placeholder="1" min="1" required>
                @error('capacity')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="size" name="size" class="form-input" value="{{ old('size', $room->size) }}" placeholder="Contoh: 3×4m" required>
                @error('size')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    @php
                        ...
                        $oldFacilities = old('facilities', json_decode($room->facilities, true) ?? []);
                    @endphp
            ...
            <div class="form-group">
                ...
                <div class="file-upload">
                    <label for="image" class="file-upload-label">
                        ...
                        <div class="file-upload-text">Klik untuk mengubah foto kamar</div>
                        <div class="file-upload-hint">Format: JPG, PNG, GIF. Maksimal 2MB</div>
                    </label>
                    <input type="file" id="image" name="image" accept="image/*">
                </div>
<div class="image-preview" id="imagePreview" style="{{ $room->image ? 'display: block;' : 'display: none;' }}">
    <img id="previewImg" src="{{ $room->image ? $room->imageUrl : '' }}" alt="Current Image">
</div>
                @error('image')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-textarea" placeholder="Deskripsi detail kamar (opsional)">{{ old('description', $room->description) }}</textarea>
                @error('description')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                <div class="checkbox-item">
                    <input type="checkbox" id="is_available" name="is_available" value="1" {{ old('is_available', $room->is_available) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="checkbox-item">
                    <input type="checkbox" id="is_popular" name="is_popular" value="1" {{ old('is_popular', $room->is_popular) ? 'checked' : '' }}>
